...
In databases, *Top K* means “give me the *K* best rows, ordered by some column or value.” Commonly than means “the most recent rows,” “the highest scores,” or “the largest values.”
...
<Note>
`===` is ParadeDB's term search operator.
</Note>
