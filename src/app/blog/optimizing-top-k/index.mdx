...
Finally, we'll replace the `tsvector` expressions in our query with the generated column:
...
In ParadeDB, the analagous query to the relevance-sorted query above would be:
