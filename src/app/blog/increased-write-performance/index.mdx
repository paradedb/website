...
Ready to experience faster search indexing? [Get started with ParadeDB](https://www.paradedb.com/docs/start/install) to see how write-optimized search can simplify your architecture, and please don’t hesitate to [give us a star](https://github.com/paradedb/paradedb).
