...
Write performance is just one piece of the larger puzzle. We're continuing to invest in optimizations that make ParadeDB a true Elasticsearch alternative built on Postgres foundations. With v0.20.0 we focused on performance and on developer experience (with our new [v2 API](/blog/v2api)), and coming into 2026 we've got our sites on making joins better (if that sounds interesting to you then please reach out).
