...
<Image
  src={TantivyLayout}
  alt="Diagram showing Tantivy’s file-based index layout with postings, terms, positions, fast fields, and metadata files"
/>
...
<Image
  ...
  alt="Diagram of pg_search’s new block storage layout including metadata blocks, segment blocks, and linked blocks"
/>
