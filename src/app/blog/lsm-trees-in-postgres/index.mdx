...
To see it in action, check out [our documentation](https://www.paradedb.com/docs/start/introduction) or our [open source project](https://github.com/paradedb/paradedb)!
