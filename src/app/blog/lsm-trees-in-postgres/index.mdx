...
<Image
  ...
  alt="Diagram of an LSM tree showing memtable, flush to disk, and segment files organized into levels with compaction"
...
<Image
  ...
  alt="Diagram of hot_standby_feedback showing a standby reporting its oldest xmin to the primary to delay VACUUM cleanup"
  className="rounded-xl"
/>
