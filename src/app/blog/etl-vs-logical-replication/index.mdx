...
If you’re curious how it works, check out our [architecture](https://www.paradedb.com/docs/concepts/architecture) — and don’t hesitate to give us a [star](https://github.com/paradedb/paradedb).
