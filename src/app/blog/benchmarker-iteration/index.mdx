...
Benchmarker is open source at [github.com/paradedb/benchmarker](https://github.com/paradedb/benchmarker). The `pg_search` install steps are at [paradedb.com/docs](https://www.paradedb.com/docs/start/install).
