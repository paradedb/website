...
More detailed benchmark results can be found in the [README](https://github.com/paradedb/paradedb/blob/main/benchmarks/README.md).

## Wrapping Up

`pg_search` is ready for use today. There are two ways to try it: [installing it](https://github.com/paradedb/paradedb/tree/main/pg_search#installation) inside an existing, self-hosted Postgres instance,
...
[Slack community](/slack). And please don't hesitate to show your support by
