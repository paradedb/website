...
- As a window function, running a search query and providing aggregate results **alongside** the TopK search results
...
These examples demonstrate faceted search using window functions — returning TopK search results while providing analytics for the entire result set:
