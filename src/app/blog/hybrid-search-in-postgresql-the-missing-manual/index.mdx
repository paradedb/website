...
Ready to get started? [Install ParadeDB](https://docs.paradedb.com/documentation/getting-started/quickstart) for BM25 and pgvector for semantic search, then use RRF to combine them into hybrid search that actually works, and please don’t hesitate to [give us a star](https://github.com/paradedb/paradedb).
