...
Ready to get started? Install [ParadeDB](https://www.paradedb.com) for BM25 and pgvector for semantic search, then use RRF to combine them into hybrid search that actually works.
