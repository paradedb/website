...
<Note>
  ...
  guides](https://www.paradedb.com/docs/operate/deploy/overview).
</Note>
...
<Note>
  ...
  image](https://hub.docker.com/r/paradedb/paradedb) then pgvector will be
...
Ready to get started? [Install ParadeDB](https://www.paradedb.com/docs/start/install) and use RRF to combine BM25 with pgvector into hybrid search that actually works, and please don’t hesitate to [give us a star](https://github.com/paradedb/paradedb).
