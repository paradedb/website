...
import AgplImage from "../../../public/blog/agpl.png"

const Title = () => (
  <h2 className="text-3xl font-extrabold">Why We Picked AGPL</h2>
)
const SplashImage = () => (
  <img src={AgplImage.src} alt="AGPL" className="rounded-xl" />
)
...
export default async function Agpl() {
  return (
    <article className="prose mx-auto max-w-2xl">
      <Title />
      <MDXServerComponent source={localMdx} components={{ SplashImage }} />
    </article>
  )
}
