...
<Note>
  **Update (v0.22.x):** Since this post was published, we've improved
  MVCC-accurate faceting performance by roughly 40%. The benchmarks above
  reflect the original release — real-world results with v0.22.x and later will
  be even faster.
</Note>
