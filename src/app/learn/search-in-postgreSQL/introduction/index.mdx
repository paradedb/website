...
<Note>
  Both approaches maintain PostgreSQL's ACID guarantees and transactional consistency, although ParadeDB can also be deployed as a logical follower to a standard PostgreSQL node.
</Note>
