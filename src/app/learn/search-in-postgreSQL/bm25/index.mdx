...
**Term saturation**: If a document mentions "optimization" 50 times, ts_rank keeps increasing the score linearly. BM25 recognizes diminishing returns—after a certain point, more mentions don't mean more relevance.
