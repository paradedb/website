...
1. **Retrieval**: Information is retrieved from external data sources. Usually the user query will be used, with the RAG pipeline employng vector search or full-text search to surface relevant information.
