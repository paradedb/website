...
<Note>
The full BM25 formula is slightly more complex. It includes tunable parameters $k₁$ (how quickly term frequency saturates) and $b$ (how strongly document length is normalized).
