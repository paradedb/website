...
<Note>
Systems like [Elasticsearch](https://github.com/elastic/elasticsearch), [Solr](https://github.com/apache/solr), and [ParadeDB](https://github.com/paradedb/paradedb) manage this entire pipeline automatically, allowing developers to add high-quality search to their applications without reinventing the underlying mechanics.

[PostgreSQL](https://www.postgresql.org/) (without the [pg_search](https://github.com/paradedb/paradedb) extension) offers some of this functionality, stopping short at BM25 ranking.
</Note>
...
- Promimity queries find words which are located close to other words (`dogs within 5 words of cats`).
