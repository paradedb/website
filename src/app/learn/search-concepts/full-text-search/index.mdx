...
After tokenization and normalization, the inverted index looks like this (using an [english language tokenizer](https://www.paradedb.com/docs/reference/tokenizers/available-tokenizers/simple) with no stemming):
