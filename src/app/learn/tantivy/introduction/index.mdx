...
**Text Analysis:**
- Configurable [tokenization](/learn/search-concepts/tokenization) pipeline with language support
...
These ecosystem projects demonstrate Tantivy's flexibility as a foundation for building complete search solutions when the library alone isn't enough for your use case.
