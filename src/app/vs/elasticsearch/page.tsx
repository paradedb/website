  ...
  techTable: {
    ...
    rows: [
      ...
      },
      {
        ...
        them: (
          <>
            ...
            inside ES (refresh, ~1s); fed from a database, the sync pipeline
            adds lag and a window where the two disagree
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        us: (
          <>
            <A href="/learn/search-concepts/bm25">BM25</A> with corpus
            statistics
          </>
        ),
      ...
      },
      {
        ...
        them: (
          <>
            ...
            <A
              href={`${ES}/reference/elasticsearch/rest-apis/reciprocal-rank-fusion`}
            >
              RRF retrievers
            </A>{" "}
