...
const inputStyles = tv({
  base: [
    ...
    focusInput,
    // invalid (optional)
    // "aria-[invalid=true]: aria-[invalid=true]:ring-2 aria-[invalid=true]:ring-red-200 aria-[invalid=true]:border-red-500 invalid:ring-2 invalid:ring-red-200 invalid:border-red-500"
