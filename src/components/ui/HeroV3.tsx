    ...
    <div className="w-full pt-4">
      ...
      >
        <div className="px-2 md:px-12 w-full h-full flex flex-col flex-grow relative">
          ...
          <div className="absolute inset-y-0 left-2 md:left-12 right-2 md:right-12 bg-white dark:bg-slate-950 -z-20" />
          ...
          <div className="relative flex flex-col items-center justify-center px-4 sm:pt-24 pt-12 text-center">
            ...
            <div className="relative z-20 mt-auto flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center mb-12 sm:mb-20">
