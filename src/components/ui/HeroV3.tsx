      ...
      >
        ...
        <div className="px-2 md:px-12 w-full h-full flex flex-col flex-grow relative">
          ...
          <div className="flex flex-col items-center w-full relative z-20">
            ...
            >
                        Simple, Elastic-Quality <br className="hidden sm:block" /> <span className="text-highlight-blink">Search</span> for Postgres
            </h1>
          </div>
          ...
          <div className="relative z-20 mt-auto flex flex-col items-center">
                      <p className="text-base sm:text-lg text-gray-800 dark:text-slate-300 mb-8 mt-4">
                        You want better search, not the burden of Elasticsearch. <br className="hidden sm:block" /> ParadeDB is
