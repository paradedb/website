...
const CloudPlatforms = [
  ...
  },
  {
    ...
    deployUrl:
      "https://www.paradedb.com/docs/operate/deploy/cloud-platforms/fly",
    icon: (
      <svg
        viewBox="0 0 24 24"
        className="size-[1.6rem]"
  ...
  },
  {
    ...
    deployUrl:
      "https://www.paradedb.com/docs/operate/deploy/cloud-platforms/digitalocean",
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  },
  {
    ...
    className: "",
    deployUrl:
      "https://www.paradedb.com/docs/operate/deploy/cloud-platforms/dokku",
    icon: (
      <svg
        viewBox="0 0 89 62"
                    ...
                    <div className="flex flex-col flex-1 bg-transparent px-5 sm:px-8 py-10 sm:py-12 z-10 w-full items-center">
                      <div className="w-full max-w-[460px] flex flex-col h-full">
                        ...
                        <div className="flex flex-col text-left flex-1">
                          ...
                          <Link
                            href="https://www.paradedb.com/docs/start/ai-agents"
                            target="_blank"
                            className="mt-auto flex w-fit items-center gap-1 text-sm font-semibold text-indigo-600 dark:text-indigo-400 hover:text-indigo-700 dark:hover:text-indigo-300"
                          >
                            Learn more
                      ...
                      <div className="w-full max-w-[460px] flex flex-col h-full">
                        ...
                        <div className="flex flex-col text-left flex-1">
                          ...
                          <div className="mt-auto flex flex-col gap-2">
                            <Link
                              href="https://www.paradedb.com/docs/start/connect-your-app"
                              target="_blank"
