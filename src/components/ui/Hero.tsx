...
export default function Hero() {
  return (
    ...
    >
      <Link target="_blank" href="https://www.ubicloud.com/blog/elastic-quality-full-text-search-on-postgres">
            <div className="mx-auto px-4 py-2 ring ring-slate-200 ring-1 rounded-full text-xs bg-slate-50 text-indigo-950 flex space-x-2 group cursor-pointer">
            ...
            <div>
              Announcing our partnership with Ubicloud
            </div>
            <ArrowAnimated className="stroke-indigo-900 relative top-1 w-2 h-2" aria-hidden="true" />
          </div>
      </Link>
      <h1
        id="hero-title"
