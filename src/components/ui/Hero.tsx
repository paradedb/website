...
export default function Hero() {
  return (
    ...
    >
      ...
      >
        The <span className="bg-indigo-100 text-indigo-600">Transactional</span><br />
      ...
      >
        Zero ETL full-text search and analytics from your source of truth. Backed by ACID guarantees and PostgreSQL's legendary reliability.
      </p>
      <div
