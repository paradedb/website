...
function GridSquare() {
  ...
  return (
    <div
      className="absolute w-6 h-6 bg-slate-300/40 dark:bg-slate-600/40"
      style={{
        left: "50%",
        top: 0,
...
export function GridBackground({ className }: { className?: string }) {
  return (
    <div className={classNames("absolute inset-0 -z-10 h-full w-full bg-grid-pattern bg-[size:24px_24px] bg-[position:center_top] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_0%,transparent_100%)]", className)}>
      {/* Filled squares */}
