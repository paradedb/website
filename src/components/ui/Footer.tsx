  ...
  return (
    <footer id="footer" className="relative w-full overflow-hidden">
      ...
      <div className="px-2 md:px-12 w-full flex flex-col relative pb-4">
        <div className="relative max-w-[1128px] mx-auto w-full pt-16 md:pt-24 pb-0 px-6 md:px-12">
          <div className="xl:grid xl:grid-cols-3 xl:gap-20">
            <div className="space-y-8">
              ...
              <p className="mt-8 text-sm leading-6 text-gray-600 max-w-xs">
                Simple, Elastic-Quality Search for Postgres.
              </p>
              <div className="pt-4">
                <Button asChild className="h-10 rounded-none bg-indigo-600 ring-2 ring-indigo-400 border-1 border-indigo-400 text-white font-semibold shadow-none">
        ...
        <div className="border-t border-slate-200 mt-16 md:mt-24">
