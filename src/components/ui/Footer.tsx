  ...
  return (
    <footer
      ...
      className={classNames(
        ...
        isHomePage ? "bg-indigo-600 text-white" : "bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100"
      )}
    >
      ...
      <div className="px-4 md:px-12 w-full flex flex-col relative pb-0">
          ...
          <div className="xl:grid xl:grid-cols-3 xl:gap-20">
            <div className="space-y-8">
              <Link href={siteConfig.baseLinks.home}>
                <DatabaseLogo className={classNames(
                  "w-32 transition-colors",
                  isHomePage ? "brightness-0 invert" : "dark:brightness-0 dark:invert"
                )} />
              </Link>
              <p className={classNames(
                "mt-4 md:mt-8 text-sm leading-6 max-w-xs",
                isHomePage ? "text-indigo-50" : "text-gray-600 dark:text-slate-400"
              )}>
              ...
              <div className="grid grid-cols-2 gap-8">
                <div>
                  <h3 className={classNames(
                    ...
                    isHomePage ? "text-white" : "text-gray-900 dark:text-slate-100"
                  )}>
                    Company
                  </h3>
        ...
        <div className="relative mt-16 md:mt-24">
          ...
          <div className="w-full px-6 md:px-12 pt-8 sm:pt-4 pb-4 flex flex-col items-center justify-between gap-6 sm:flex-row">
            <p className={classNames(
              "text-sm leading-5",
              isHomePage ? "text-indigo-100" : "text-gray-500 dark:text-slate-400"
            )}>
