...
export function Navigation() {
  ...
  return (
    <div>
      <div className="flex w-screen justify-center space-x-4 bg-indigo-600 px-2 md:px-12 py-4 text-center text-white">
      ...
      <header
        className={classNames(
          "z-50 mx-2 md:mx-12 mt-4 flex transform-gpu animate-slide-down-fade justify-center overflow-hidden rounded-xl border border-transparent px-6 py-3 transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1.03)] will-change-transform md:mt-4 md:px-3",
          open === true ? "h-52" : "h-16",
          open === true
