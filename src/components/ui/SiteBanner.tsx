  ...
  return (
    <div className="relative z-50 w-full bg-indigo-600">
      <Link
        ...
        className="group flex w-full items-center justify-center gap-2 border-b border-white/20 bg-white/10 px-4 py-3 text-center text-xs font-medium text-white backdrop-blur-md transition-colors hover:bg-white/15 sm:text-sm"
      >
