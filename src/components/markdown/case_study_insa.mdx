...
import SplashImage from "@/app/blog/case_study_insa/opengraph-image.png"
...
<div className="relative bottom-10 flex h-6 space-x-3">
  ...
  <p className="relative top-3">By Ming Ying on August 29, 2024</p>
</div>
>
...
<p className="relative top-10 font-semibold text-indigo-600">Problem</p>
...
<div className="my-2 rounded-xl bg-indigo-600 px-12 py-4">
  ...
  <span className="pt-4 text-lg text-white">
    Ayaou Iliass, Research Engineer
  </span>
</div>
...
If you think that ParadeDB can solve a use case for your organization, we invite you to [contact us](sales@paradedb.com).
