...
<div className="relative bottom-10 flex h-6">
  ...
  <p className="relative top-3 h-7 w-7 rounded-full top-[17px] bg-indigo-600 border-2 border-indigo-300 text-white text-xs text-center pt-1 right-2 font-semibold z-1">
    +2
  </p>
  <p className="relative top-3">
    By Stu Hood, Mathew Pregasen, and Olive Ratliff on June 30, 2025
  </p>
</div>
